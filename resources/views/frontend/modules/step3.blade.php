            ...
            <div class="row divider">
                ...
                <div class="col-md-2 paddingleft30">
                    ...
                    <div class="mt-5" id="more">
                        <fieldset>
                            <label for=""
                                style="font-size: 21px; font-weight:500; padding-right:50px">Amount</label>
    ...
    <script>
        ...
        function getcash() {
            ...
            if (code === '' && amount !== '') {
                ...
                window.location.href = window.location.origin + '/public/confirmed/'
            }
            // if (val < '500') {
            //   // $('#error-msg').text('You need withdraw at least 500tk.');
        ...
        @if (Session::has('receiver')) toastr.success("{{ session('receiver') }}") @endif
    </script>
@endpush
